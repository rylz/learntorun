# Derived from example.py in osim-rl
import gym
import numpy as np
import sys
...
# Ctrl + C.
if args.train:
    agent.fit(env, nb_steps=nallsteps, visualize=True, verbose=1, nb_max_episode_steps=10000, log_interval=10000)
