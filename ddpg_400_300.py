...
parser.add_argument('--load', dest='load', action='store', default=None)
...
# Ctrl + C.
weights_filename = 'ddpg_{}_weights.h5f'.format(args.model)
if args.train:
    if args.load:
        agent.load_model(args.load)
    checkpoint_weights_filename = 'ddpg_' + args.model + '_weights_{step}.h5f'
    log_filename = 'ddpg_{}_log.json'.format(args.model)
